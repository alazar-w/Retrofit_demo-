...
//            }
            ...
            //we are passing in the id of the item we clicked on from the master view. so first we retrieve the argument from our fragment data and then pass it into our Retrofit
            //method as parameter.Retrofit will map that idea to our URL and adjust the request necessary.
